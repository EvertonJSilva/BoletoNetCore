...
namespace BoletoNetCore.Testes
{
    ...
    public class BancoBrasilCarteira17027Tests
    {
        ...
        public void Deve_criar_boleto_brasil_17_027_com_digito_verificador_Nossonr_Barra_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
