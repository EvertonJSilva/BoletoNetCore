...
{
	partial class BancoBanrisul : IBancoCNAB150
	{
		public override string GerarHeaderRemessaCNAB150(ref int numeroArquivoRemessa, ref int numeroRegistro)
		{
			try
			{
				...
				reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0003, 005, 0, Beneficiario.Codigo, '0');
				reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0008, 015, 0, ' ', ' ');
				reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0023, 020, 0, Beneficiario.Nome, ' ');
				reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0043, 003, 0, "041", '0');
				reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0046, 020, 0, "BANRISUL", ' ');
				...
				reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0080, 002, 0, "05", '0');
        ...
        public override void LerDetalheRetornoCNAB150SegmentoF(ref Boleto boleto, string registro)
        {
            try
            {
                ...
                {
                    boleto.Pagador.CPFCNPJ = cpfCnpj.Left(4) == "0000" || cpfCnpj.Length <= 11 ? cpfCnpj.PadLeft(11,'0').Right(11) : cpfCnpj;
                }
