...
{
    partial class BancoCaixa : IBancoCNAB150
    {
        public override string GerarHeaderRemessaCNAB150(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0043, 003, 0, "104", '0');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0046, 020, 0, "CEF", ' ');
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0117, 027, 0, Empty, ' ');
        ...
        public override string GerarTrailerRemessaCNAB150(int numeroRegistroGeral, decimal valorBoletoGeral, int numeroRegistroCobrancaSimples, decimal valorCobrancaSimples, int numeroRegistroCobrancaVinculada, decimal valorCobrancaVinculada, int numeroRegistroCobrancaCaucionada, decimal valorCobrancaCaucionada, int numeroRegistroCobrancaDescontada, decimal valorCobrancaDescontada)
        {
            try
            {
                ...
                var numeroLinhasNoLote = numeroRegistroGeral + 2;
                var numeroRegistros = numeroRegistroGeral + 1;

                var reg = new TRegistroEDI();
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0001, 001, 0, "Z", '0');
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0002, 006, 0, numeroLinhasNoLote, '0');
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0144, 006, 0, numeroRegistros, '0');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0150, 001, 0, Empty, ' ');
        ...
        private string GerarDetalheSegmentoERemessaCNAB150(Boleto boleto, ref int registro)
        {
            ...
            reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0130, 006, 0, registro, '0');
            reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0136, 008, 0, Empty, ' ');
            reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0144, 006, 0, registro, '0');
